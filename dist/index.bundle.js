...
const submitMealPlan = (() => {
  ...
  selectSubmitFormButton.addEventListener("click", (e) => {
    ...
    const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dateValue), "PPP");
