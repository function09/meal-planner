...
const mealPlanManager = (() => {
  ...
  const submitMealPlan = (() => {
    ...
    selectSubmitFormButton.addEventListener("click", (form) => {
      ...
      const newDisplayMealPlan = new _displayMealPlans__WEBPACK_IMPORTED_MODULE_1__.DisplayMealPlan(
        date,
        breakfast,
        lunch,
        dinner
