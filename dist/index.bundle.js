...
class MealManager {
  ...
  addMeal(mainDish, sideDish, drink) {
    this.mealArray.push(new _meals__WEBPACK_IMPORTED_MODULE_0__.Meals(mainDish, sideDish, drink));
  }
}
