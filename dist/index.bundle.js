...
const DOM = (() => {
  ...
  selectContainer.addEventListener("click", (event) => {
    ...
    if (event.target.id === "createNewMeal") {
      ...
      const dateValue = document.querySelector("#date").value;
      const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(`${dateValue}T12:00`), "PPPP");
      const breakfast = mealArray[0];
      const lunch = mealArray[1];
      const dinner = mealArray[2];
      ...
      const selectInput = selection.parentElement.firstElementChild;
      const createSpan = document.createElement("span");
      const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(`${selectInput.value}T12:00`), "PPPP");
