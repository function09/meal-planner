...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DisplayMealPlan": () => (/* binding */ DisplayMealPlan)
/* harmony export */ });
...
const mealPlanManager = (() => {
  ...
  const submitMealPlan = (() => {
    ...
    selectSubmitFormButton.addEventListener("click", (form) => {
      ...
      const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(`${dateValue}T12:00`), "PPP");
      const breakfast = mealArray[0];
      const lunch = mealArray[1];
      const dinner = mealArray[2];
      const newDisplayMealPlan = new _displayMealPlans__WEBPACK_IMPORTED_MODULE_1__.DisplayMealPlan(date);
    ...
    selectContainer.addEventListener("click", (event) => {
      ...
      if (event.target.className === "removeMealPlan") {
        if (selectRemoveButtonValue === selectParentElement) {
          ...
          _displayMealPlans__WEBPACK_IMPORTED_MODULE_1__.DisplayMealPlan.assignID();
          _displayMealPlans__WEBPACK_IMPORTED_MODULE_1__.DisplayMealPlan.assignIndexValues();
          _displayMealPlans__WEBPACK_IMPORTED_MODULE_1__.DisplayMealPlan.assignDataValue();
        ...
        const createSpan = document.createElement("span");
        const date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(`${selectInput.value}T12:00`), "PPP");
